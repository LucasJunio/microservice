...
// router.route("/parada_programada/classificacao_parada").get(classifsauicacao_parada.getClassificacao);
...
// router.route("/parada_programada/param_programacao_paradas").get(pasaram_programacao_paradas.get);
...
router.route("/parada_programada/reprogramacao").put((req, res, next) => {
  programacao_parada.putReprogramacao(req, res, next);
});
