...
export class UnidadeGeradora {
  @ManyToOne(
    () => Usina,
    (SAU_USINA: Usina) => SAU_USINA.sauUnidadeGeradoras,
    { nullable: false }
  )
  ...
  @OneToMany(
    () => Pgi,
    (SAU_PGI: Pgi) => SAU_PGI.cdUnidadeGeradora
  )
  public sauPgis: Pgi[]

  @OneToMany(
    () => ProgramacaoParadaUG,
    (SAU_PROGRAMACAO_PARADA_UG: ProgramacaoParadaUG) => SAU_PROGRAMACAO_PARADA_UG.cdUnidadeGeradora
  )
